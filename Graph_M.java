...
import java.io.*;
	...
	public class Graph_M 
	{
		...
		{
			System.out.println("\t Sight Seeing Map Location");
			System.out.println("\t------------------");
			System.out.println("----------------------------------------------------\n");
			ArrayList<String> keys = new ArrayList<>(vtces.keySet());
	...
	/////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		public static void Create_Metro_Map(Graph_M g)
		{
			g.addVertex("Ujjain");
			g.addVertex("Mandu");
			g.addVertex("Bhimbetka");
			g.addVertex("Shivpuri");
			g.addVertex("Sunder Mahal");
			g.addVertex("Phool Bagh");
			g.addVertex("Chaturbhuj Temple");
			g.addVertex("Sanchi Stupa");
			g.addVertex("Scindia Museum");
			g.addVertex("Bhimbetka Caves");
			g.addVertex("Upper Lake");
			g.addVertex("Lower lake ");
			g.addVertex("WildLife Sanchuries");
			g.addVertex("Birla Museum");
			g.addVertex("Bhopal");
			...
			g.addEdge("Ujjain", "Indore", 8);
			g.addEdge("Indore", "Maheshwar", 10);
			g.addEdge("Maheshwar", "Omkareshwar", 8);
			g.addEdge("omkareshwar", "Bhimbetka", 6);
			g.addEdge("Bhimbetka", "Dewas", 9);
			g.addEdge("Dewas", "Sehore", 7);
			g.addEdge("Sehore", "Bhopal", 6);
			g.addEdge("Bhopal","Vidisha", 15);
			g.addEdge("Vidisha", "Sanchi", 6);
			g.addEdge("Sanchi", "Panchmarhi", 7);
			g.addEdge("Panchmarhi", "Kanha", 1);
			g.addEdge("Kanha", "Mandla", 2);
			g.addEdge("Mandla", "Bandhavgarh", 5);
			g.addEdge("Bandhavgarh", "ChitraKoot", 2);
			g.addEdge("ChitraKoot", "Khajuraho", 7);
			g.addEdge("Khajuraho", "Orchha", 8);
			g.addEdge("Orchha", "Chanderi", 2);
			g.addEdge("Chanderi", "Gwalior", 2);
			g.addEdge("Gwalior", "Shivpuri", 3);
			g.addEdge("Shivpuri", "Bhopal", 3);
		}
